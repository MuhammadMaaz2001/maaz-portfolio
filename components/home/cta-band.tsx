    ...
    <section id="contact">
      <div className="wrap">
        <div className="cta-band" data-reveal="">
          ...
          <h2 style={{ margin: "0 auto 16px" }}>Have a project in mind? Let&apos;s build it.</h2>
          <p>Open to full-time roles, freelance work, and collaboration.</p>
          <div className="cta-row">
            <a href="mailto:maazm6387@gmail.com" className="btn btn-primary">
              Email Me
            </a>
            <a
